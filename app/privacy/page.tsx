...
export default function PrivacyPage() {
  return <main><div className="page-shell policy-shell">
    ...
    <article className="policy-content">
      ...
      <section><h2>Information we may process</h2><p>For reviews submitted through Reverlo, this may include the submitted username, rating, written review, product or deal description, selected platform, review identifier, and submission date.</p><p>When eBay feedback import is connected, Reverlo may process feedback data returned by eBay that is relevant to seller feedback, such as the eBay feedback ID, commenter username or public user ID, feedback comment, Positive/Neutral/Negative feedback type, feedback date, and item or listing information when eBay provides it. Reverlo does not invent information that eBay does not return.</p></section>
