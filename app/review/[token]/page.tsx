...
export default async function ReviewLinkPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  return <main><div className="page-shell review-page-shell"><Header /><section className="review-hero"><p className="section-kicker">Buyer reference</p><h1>Leave a review.</h1><p>Share a concise, honest reference about the completed deal below. A review reference is generated automatically after submission.</p></section><ReviewForm token={token} productDeal={link.productDeal} defaultPlatform={link.defaultPlatform} /><footer><span>© {new Date().getFullYear()} Reverlo</span><span>Independent reputation profile</span><a href="/">Return to Reverlo ←</a></footer></div></main>;
}
